...
public class Fragmenta extends Fragment {
    private Shi1 shi1;
    private int a;
    private List<Rec.DataBean.DatasBean> datasBeans;
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    List<Ban.DataBean> dataBeans = (List<Ban.DataBean>) msg.obj;
                    shi1.lun(dataBeans);
                    break;
                case 2:
                    datasBeans = (List<Rec.DataBean.DatasBean>) msg.obj;
                    shi1.add(datasBeans);
                    break;
            }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = LayoutInflater.from(getActivity()).inflate(R.layout.seleven, container, false);
        view(inflate);
        return inflate;
    }

    private void view(View inflate) {
        ...
        shi1.setOnClickListener(new Shi1.OnClickListener() {
            ...
            public void onClickListener(int i) {
                ...
                Rec.DataBean.DatasBean datasBean = datasBeans.get(i);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case 1:
                ...
                break;
            case 2:
                Rec.DataBean.DatasBean datasBean = datasBeans.get(a);
