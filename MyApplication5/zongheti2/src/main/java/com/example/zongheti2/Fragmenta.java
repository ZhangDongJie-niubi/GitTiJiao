...
public class Fragmenta extends Fragment {
    private Shi1 shi1;
    private int a;
    private List<Src.DataBean.DatasBean> obj1;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 1:
                    ...
                    break;
                case 2:
                    obj1 = (List<Src.DataBean.DatasBean>) msg.obj;
                    shi1.srcj(obj1);
                    break;
            }
        }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.nine, null);
        init(inflate);
        return inflate;
    }
    ...
    private void init(final View inflate) {
        ...
        shi1.setOnClickListener(new Shi1.OnClickListener() {
            ...
            public void onClickListener(int i) {
                ...
                Src.DataBean.DatasBean datasBean = obj1.get(a);
    ...
    private void recd() {
        try {
            ...
            String s = bos.toString();
            Gson gson = new Gson();
            Src src = gson.fromJson(s, Src.class);
            List<Src.DataBean.DatasBean> datas = src.getData().getDatas();
            Message msg = new Message();
            msg.what=2;
            msg.obj=datas;
            handler.sendMessage(msg);
