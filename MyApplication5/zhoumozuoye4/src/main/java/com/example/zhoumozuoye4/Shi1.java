...
public class Shi1 extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if (getItemViewType(i) == RECTEXT) {
            ...
            ((RecyclerViewHolder) viewHolder).tv1.setText(datasBean.getTitle());
            ((RecyclerViewHolder) viewHolder).tv2.setText(datasBean.getChapterName());
            final int finalI = i;
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View v) {
                    if (onLongClickListener != null) {
                        onLongClickListener.onLongClickListener(finalI);
                    }
                    return false;
                }
            });
            ...
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onClickListener != null) {
                        onClickListener.onClickListener(finalI1);
                    }
                }
            });

        } else {
            final Ban.DataBean dataBean = ban.get(i);
