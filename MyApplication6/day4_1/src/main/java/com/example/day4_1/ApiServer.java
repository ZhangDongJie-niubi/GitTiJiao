...
public interface ApiServer {
    ...
    @POST()
    @Headers("Content-Type:application/x-www-form-urlencoded")
    Call<ResponseBody> post4(@Url String url, @Body RequestBody requestBody);

    @POST("dish_list.php")
    @FormUrlEncoded
    Call<Food> post6(@Field("stage_id") String stage_id, @Field("limit") String limit, @Field("page") String page);
