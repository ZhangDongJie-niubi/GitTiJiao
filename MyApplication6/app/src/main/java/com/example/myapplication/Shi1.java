...
public class Shi1 extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if (getItemViewType(i) == RECTEXT) {
            ...
            Rec.DataBean.DatasBean datasBean1 = rec.get(i);
           // https://www.wanandroid.com/blogimgs/62c1bd68-b5f3-4a3c-a649-7ca8c7dfabe6.png
            Glide.with(context).load("https://www.wanandroid.com/blogimgs/62c1bd68-b5f3-4a3c-a649-7ca8c7dfabe6.png").into(((RecycleViewHolder) viewHolder).iv);
            ((RecycleViewHolder) viewHolder).tv1.setText(datasBean1.getTitle());
            ((RecycleViewHolder) viewHolder).tv2.setText(datasBean1.getChapterName());
            final int finalI = i;
