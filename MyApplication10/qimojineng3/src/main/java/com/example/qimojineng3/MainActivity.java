                ...
                foodObservable.subscribeOn(Schedulers.io())
                        ...
                        .subscribe(new Observer<Food>() {
                            ...
                            public void onNext(Food value) {
                                vp.setLayoutManager(new LinearLayoutManager(MainActivity.this));
            ...
            case 2:
                ...
                foodObservable1.subscribeOn(Schedulers.io())
                        ...
                        .subscribe(new Observer<Food>() {
                            ...
                            @Override
                            public void onNext(Food value) {
                                vp.setLayoutManager(new GridLayoutManager(MainActivity.this, 2));
                                List<Food.ResultsBean> results = value.getResults();
                                Shi shi = new Shi(results, MainActivity.this);
                                vp.setAdapter(shi);
                            }
            ...
            case 3:
                ...
                foodObservable2.subscribeOn(Schedulers.io())
                        ...
                        .subscribe(new Observer<Food>() {
                            ...
                            @Override
                            public void onNext(Food value) {
                                vp.setLayoutManager(new StaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL));
                                List<Food.ResultsBean> results = value.getResults();
                                Shi shi = new Shi(results, MainActivity.this);
                                vp.setAdapter(shi);
                            }
